var minersAddr = '0x4Cd5F0068DC9c11009645957796838154ab3384b';
var tokenAddr = '0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + "DAI" + " in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + "DAI" + " first");
	} else {
